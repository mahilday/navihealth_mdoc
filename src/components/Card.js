...
const Card = ({ id }) => {
  ...
  return (
    <div className=" bg-white  divide-y-2 py-5 px-10 rounded-xl shadow-xl">
      <div className="flex md:mb-10 sm:flex-col md:flex-col md:divide-none sm:divide-none divide-x-2 py-6 h-72 sm:h-auto lg:grid md:grid xl:grid grid-cols-3  md:space-x-10 lg:space-x-10 xl:space-x-10">
        <div className="flex sm:flex-col md:flex-col items-center space-x-10">
        ...
        <div className="space-x-5 py-2 flex justify-center">
          <LocationMarkerIcon className="h-12 text-orange-free w-8" />
          <p className="space-x-3 w-60 text-gray-free text-xl">
      ...
      <div className="flex md:space-x-5 lg:space-x-5 xl:space-x-5 sm:space-y-5 py-3 sm:flex-col justify-end">
